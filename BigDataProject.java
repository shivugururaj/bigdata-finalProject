...
/*Shivu Gururaj*/
	public static void main(String[] args) throws IOException {
		...
		for (String file : trainFileArray) {
			...
			File newTrainFile = new File("trainFiles/new" + oldFile.getName().trim());
			...
			try {
				...
				while ((line = br.readLine()) != null) {
					...
					FileWriter writer = new FileWriter("trainFiles/new" + oldFile.getName().trim(), true);
	...
	private static HashMap<String, String> getSemanaMap() {
		// TODO Auto-generated method stub
		HashMap<String, String> semanaMap = new HashMap<String, String>();
		semanaMap.put("6", "7.246105780537895");
		semanaMap.put("3", "6.9559219994756925");
		semanaMap.put("7", "7.377263600770848");
		semanaMap.put("4", "7.231771964685707");
		semanaMap.put("8", "7.257236759416954");
		semanaMap.put("5", "7.31113843410661");
		semanaMap.put("9", "7.2107329695803895");
